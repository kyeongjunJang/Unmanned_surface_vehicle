...
class Fuzzy:
    ...
    def fuzzy(self):
        ...
        target_servo['RRR'] = fuzz.trimf(target_servo.universe, [-22, -18, -11])
        ...
        target_servo['LLL'] = fuzz.trimf(target_servo.universe, [11, 18, 22])
    ...
    def fuzzy_control_avoidance(self):
        ...
        #for i in range(len(self.ranges)):
                ...
                #print(i)
        if min(self.ranges) < 2.4 and abs(LiDARDEG2DEG(RAD2DEG(self.angle_min + self.angle_increment * self.idx))) < 70:
