...
class PathPlanner:
    ...
    def servo_pid_controller(self):
        ...
        self.angle = math.atan2(dx, dy) * 180. / math.pi
        ...
        # error_angle = rotate_angle - self.bearing
        ...
        print("rotate_angle : " + str(round(self.angle)) + " | error_angle : " + str(round(error_angle)) + " | servo_control : " + str(round(servo_control)))
        print("-----------------------------------------------------------------")
    ...
    def print_info(self):
        try: 
            print("-----------------------------------------------------------------")
            print("trajectory[0] : " + str(round(self.trajectory[0][0], 2)) + " , " + str(round(self.trajectory[0][1], 2)))
            print("cur_pos : " + str(round(self.cur_pos[0], 2)) + " , " + str(round(self.cur_pos[1], 2)))
    ...
    def run_to_goal(self):
        ...
        while not rospy.is_shutdown():
            ...
            if self.pp.is_finished():
                ...
                if True :#len(self.pp.cur_pos)!=0 and len(self.pp.trajectory)!=1:
                    if hz < 1:
